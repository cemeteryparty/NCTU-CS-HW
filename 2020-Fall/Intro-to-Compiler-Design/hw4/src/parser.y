...
Program:
	...
	END {
		root = new ProgramNode(@1.first_line, @1.first_column,
			...
			$1, $3, $4, static_cast<CompoundStatementNode *>($5));
...
For:
	...
	END DO {
		...
		constant = new Constant(
			std::make_shared<const PType>(PType::PrimitiveTypeEnum::kIntegerType), value);
		constant_value_node = new ConstantValueNode(@6.first_line, @6.first_column, constant);
...
Expression:
	...
	Expression MULTIPLY Expression {
		$$ = new BinaryOperatorNode(@2.first_line, @2.first_column,
			Operator::kMultiplyOp, static_cast<ExpressionNode *>($1),
			static_cast<ExpressionNode *>($3));
	}
	|
	Expression DIVIDE Expression {
		$$ = new BinaryOperatorNode(@2.first_line, @2.first_column,
			Operator::kDivideOp, static_cast<ExpressionNode *>($1),
			static_cast<ExpressionNode *>($3));
	}
	|
	Expression MOD Expression {
		$$ = new BinaryOperatorNode(@2.first_line, @2.first_column,
			Operator::kModOp, static_cast<ExpressionNode *>($1),
			static_cast<ExpressionNode *>($3));
	}
	|
	Expression PLUS Expression {
		$$ = new BinaryOperatorNode(@2.first_line, @2.first_column,
			Operator::kPlusOp, static_cast<ExpressionNode *>($1),
			static_cast<ExpressionNode *>($3));
	}
	|
	Expression MINUS Expression {
		$$ = new BinaryOperatorNode(@2.first_line, @2.first_column,
			Operator::kMinusOp, static_cast<ExpressionNode *>($1),
			static_cast<ExpressionNode *>($3));
	}
	|
	Expression LESS Expression {
		$$ = new BinaryOperatorNode(@2.first_line, @2.first_column,
			Operator::kLessOp, static_cast<ExpressionNode *>($1),
			static_cast<ExpressionNode *>($3));
	}
	|
	Expression LESS_OR_EQUAL Expression {
		$$ = new BinaryOperatorNode(@2.first_line, @2.first_column,
			Operator::kLessOrEqualOp, static_cast<ExpressionNode *>($1),
			static_cast<ExpressionNode *>($3));
	}
	|
	Expression GREATER Expression {
		$$ = new BinaryOperatorNode(@2.first_line, @2.first_column,
			Operator::kGreaterOp, static_cast<ExpressionNode *>($1),
			static_cast<ExpressionNode *>($3));
	}
	|
	Expression GREATER_OR_EQUAL Expression {
		$$ = new BinaryOperatorNode(@2.first_line, @2.first_column,
			Operator::kGreaterOrEqualOp, static_cast<ExpressionNode *>($1),
			static_cast<ExpressionNode *>($3));
	}
	|
	Expression EQUAL Expression {
		$$ = new BinaryOperatorNode(@2.first_line, @2.first_column,
			Operator::kEqualOp, static_cast<ExpressionNode *>($1),
			static_cast<ExpressionNode *>($3));
	}
	|
	Expression NOT_EQUAL Expression {
		$$ = new BinaryOperatorNode(@2.first_line, @2.first_column,
			Operator::kNotEqualOp, static_cast<ExpressionNode *>($1),
			static_cast<ExpressionNode *>($3));
	}
	|
	NOT Expression {
	...
	Expression AND Expression {
		$$ = new BinaryOperatorNode(@2.first_line, @2.first_column,
			Operator::kAndOp, static_cast<ExpressionNode *>($1),
			static_cast<ExpressionNode *>($3));
	}
	|
	Expression OR Expression {
		$$ = new BinaryOperatorNode(@2.first_line, @2.first_column,
			Operator::kOrOp, static_cast<ExpressionNode *>($1),
			static_cast<ExpressionNode *>($3));
	}
	|
	IntegerAndReal
