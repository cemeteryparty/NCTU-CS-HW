...
// implement of "class AstDumper : public AstNodeVisitor"
...
void AstDumper::visit(VariableNode &p_variable) {
	...
	std::printf("variable <line: %u, col: %u> %s %s\n",
		...
		p_variable.getNameCString(), p_variable.getVariableTypeCString());
...
void AstDumper::visit(ConstantValueNode &p_constant_value) {
	...
	std::printf("constant <line: %u, col: %u> %s\n",
		p_constant_value.getLocation().line, p_constant_value.getLocation().col,
